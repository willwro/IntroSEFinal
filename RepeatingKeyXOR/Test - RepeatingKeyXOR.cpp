...
#include <vector>
#include <string>
#include "myrepeatingkeyxor.h" // Replace with your implementation file
...
TEST(FindKeySizeTests, KeySizeTest) {
    string ciphertext = "your base64-decoded ciphertext here";
...
// Test breaking the Vigenère cipher
